...
class Dimensions {
  ...
  static double pageViewTextContainer = screenHeight / 25.03;
...
//dynamic fonts and border radius
  ...
  //article-info image height
  static double articleImage = screenWidth / 2.25;

//bottom height
  //static double bottomHeightBar = screenWidth / 2.25;
